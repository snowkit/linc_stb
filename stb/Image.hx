...
extern class Image {
    ...
    //hdr
        ...
        @:native("linc::stb_image::is_hdr")
        static function is_hdr(filename:String) : Bool;

        @:native("linc::stb_image::is_hdr_from_memory")
        static function is_hdr_from_memory(bytes:BytesData, length:Int) : Bool;
